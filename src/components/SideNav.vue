...
const sideMenuStyle: string = "animate-menuTransitionDown absolute z-50 right-[10%] top-[55%] flex-row text-7xl font-title text-right"
...
const topBarMenuStyle: string = "animate-menuTransitionUp fixed z-50 h-24 right-6 top-6 flex-row text-xl font-title text-right"
