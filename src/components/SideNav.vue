...
const sideItemStyle: string = "relative mb-12 pl-6 pt-2 after:bg-greenish after:z-[-1] after:absolute after:left-0 after:bottom-0 after:h-[50%] after:w-0 hover:after:w-[100%] cursor-pointer after:transition-all after:duration-200"
...
const topBarItemStyle: string = "relative ml-24 after:bg-greenish after:z-[-1] after:absolute after:left-0 after:bottom-0 after:h-[50%] after:w-0 cursor-pointer after:transition-all after:duration-200" 
