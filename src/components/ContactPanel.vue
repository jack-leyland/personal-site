<template>
    ...
    <div class="flex">
        <a href="https://github.com/jack-leyland">
            <svg class="h-14 w-14 mr-8 hover:fill-mainPurple transition-all duration-300 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path
        ...
        <a href="https://www.linkedin.com/in/jack-leyland-09b31b79/">
            <svg class="h-14 w-14 cursor-pointer hover:fill-mainPurple transition-all duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path
